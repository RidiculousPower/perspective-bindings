...
module ::Magnets::Bindings::BindingContext
  
  ###############################
  #  binding_context_for_route  #
  ###############################

  def binding_context_for_route( shared_alias_name, starting_context, binding_route, accessor )
