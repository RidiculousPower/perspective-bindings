...
RSpec::Matchers.define :match_types do |*match_types|
  ...
  match do |binding_definition_instance|
    ...
    if match_types.delete( :class )
      unless fail_string or matched = binding_definition_instance.binding_value_valid?( Object )
    ...
    if match_types.delete( :module )
      unless fail_string or matched = binding_definition_instance.binding_value_valid?( Kernel )
    ...
    if match_types.delete( :integer )
      integer = 42
      unless fail_string or matched = binding_definition_instance.binding_value_valid?( integer )
    ...
    if match_types.delete( :float )
      float = 42.0
      unless fail_string or matched = binding_definition_instance.binding_value_valid?( float )
    ...
    if match_types.delete( :complex )
      complex = Complex( 1, 2 )
      unless fail_string or matched = binding_definition_instance.binding_value_valid?( complex )
    ...
    if match_types.delete( :rational )
      ...
      unless fail_string or matched = binding_definition_instance.binding_value_valid?( rational )
    ...
    if match_types.delete( :regexp )
      regexp = /some_regexp/
      unless fail_string or matched = binding_definition_instance.binding_value_valid?( regexp )
    ...
    if match_types.delete( :text )
      string_text = 'string'
      unless fail_string or matched = binding_definition_instance.binding_value_valid?( string_text )
    ...
    if match_types.delete( :text )
      symbol_text = :symbol
      unless fail_string or matched = binding_definition_instance.binding_value_valid?( symbol_text )
    ...
    if match_types.delete( :true_or_false )
      unless fail_string or matched = binding_definition_instance.binding_value_valid?( true )
        fail_string = 'Match types included :true_or_false but ' << true.to_s << ' reported not valid.'
      end
    end
    
    if match_types.delete( :true_or_false )
      unless fail_string or matched = binding_definition_instance.binding_value_valid?( false )
    ...
    if match_types.delete( :uri ) or match_types.include?( :text )
      ...
      unless fail_string or matched = binding_definition_instance.binding_value_valid?( uri_string )
    ...
    if match_types.delete( :uri )
      ...
      unless fail_string or matched = binding_definition_instance.binding_value_valid?( uri_object )
    ...
    unless fail_string
      match_types.each do |this_match_object_instance|
        unless matched = binding_definition_instance.binding_value_valid?( this_match_object_instance )
