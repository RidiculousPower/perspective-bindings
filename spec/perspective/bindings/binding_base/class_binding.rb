...
shared_examples_for :base_class_binding do
  ...
  context '#«configure»' do
    another_configure_block = ::Proc.new { puts 'another block' }
    let( :another_configure_block ) { another_configure_block }
    it 'topclass binding can configure via proc' do
      topclass_class_binding.«configuration_procs».should == topclass_class_binding_configuration_procs
      topclass_class_binding.«configure»( & another_configure_block )
      topclass_class_binding_configuration_procs.push( another_configure_block )
      topclass_class_binding.«configuration_procs».should == topclass_class_binding_configuration_procs
      topclass_class_binding_configuration_procs.delete( another_configure_block )
...
#      subclass_class_binding.«configuration_procs».delete( another_configure_block )
    ...
    it 'subclass can configure its own procs in addition' do
      subclass_class_binding.«configuration_procs».should == subclass_class_binding_configuration_procs
      subclass_class_binding.«configure»( & another_configure_block )
      subclass_class_binding_configuration_procs.push( another_configure_block )
      topclass_class_binding.«configuration_procs».should == topclass_class_binding_configuration_procs
      subclass_class_binding.«configuration_procs».should == subclass_class_binding_configuration_procs
      subclass_class_binding.«configuration_procs».delete( another_configure_block )
    end
  ...
  context '#permits_multiple?, #permits_multiple=' do
    after :each do
      topclass_class_binding.•permits_multiple?.clear
      subclass_class_binding.•permits_multiple?.clear
    end
    it 'topclass binding can permit multiple' do
      ...
      topclass_class_binding.permits_multiple = false
      topclass_class_binding.permits_multiple?.should be false
    end
  ...
  context '#required?, #required=' do
    after :each do
      topclass_class_binding.•required?.clear
      subclass_class_binding.•required?.clear
    end
    it 'topclass binding can require binding' do
      ...
      topclass_class_binding.required = false
      topclass_class_binding.required?.should be false
    end
  ...
  context '#optional?, #optional=' do
    ...
    it 'topclass binding can require binding and query via optional? (inverted)' do
      ...
      topclass_class_binding.optional = true
      topclass_class_binding.optional?.should be true
    end
