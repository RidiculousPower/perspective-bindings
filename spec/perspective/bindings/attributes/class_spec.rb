...
describe ::Perspective::Bindings::Attributes::Class do
  ...
  it 'can ensure class instances are valid binding objects' do
    class ::Perspective::Bindings::Attributes::Class::Mock
      include ::Perspective::Bindings::Attributes::Class
    end
    ::Perspective::Bindings::Attributes::Class::Mock.new.instance_eval do
      # class
