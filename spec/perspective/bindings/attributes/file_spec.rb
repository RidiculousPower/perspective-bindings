...
describe ::Perspective::Bindings::Attributes::File do
  ...
  it 'can ensure class instances are valid binding objects' do
    class ::Perspective::Bindings::Attributes::File::Mock
      include ::Perspective::Bindings::Attributes::File
    end
    ::Perspective::Bindings::Attributes::File::Mock.new.instance_eval do
      # class
      __binding_value_valid__?( Object ).should == false
      # module
      __binding_value_valid__?( Kernel ).should == false
      # file
      __binding_value_valid__?( File.new( __FILE__ ) ).should == true
      # integer
