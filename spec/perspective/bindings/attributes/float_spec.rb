...
describe ::Perspective::Bindings::Attributes::Float do
  ...
  it 'can ensure class instances are valid binding objects' do
    class ::Perspective::Bindings::Attributes::Float::Mock
      include ::Perspective::Bindings::Attributes::Float
    end
    ::Perspective::Bindings::Attributes::Float::Mock.new.instance_eval do
      # class
