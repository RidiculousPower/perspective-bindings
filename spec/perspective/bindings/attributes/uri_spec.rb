...
describe ::Perspective::Bindings::Attributes::URI do
  ...
  it 'can ensure class instances are valid binding objects' do
    class ::Perspective::Bindings::Attributes::URI::Mock
      include ::Perspective::Bindings::Attributes::URI
    end
    ::Perspective::Bindings::Attributes::URI::Mock.new.instance_eval do
      # class
