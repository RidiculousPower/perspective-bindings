...
describe ::Perspective::Bindings::Attributes::Text do
  ...
  it 'can ensure class instances are valid binding objects' do
    class ::Perspective::Bindings::Attributes::Text::Mock
      include ::Perspective::Bindings::Attributes::Text
    end
    ::Perspective::Bindings::Attributes::Text::Mock.new.instance_eval do
      # class
      ...
      __binding_value_valid__?( :symbol ).should == true
      # true_false
