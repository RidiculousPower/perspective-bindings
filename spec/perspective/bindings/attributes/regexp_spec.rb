...
describe ::Perspective::Bindings::Attributes::Regexp do
  ...
  it 'can ensure class instances are valid binding objects' do
    class ::Perspective::Bindings::Attributes::Regexp::Mock
      include ::Perspective::Bindings::Attributes::Regexp
    end
    ::Perspective::Bindings::Attributes::Regexp::Mock.new.instance_eval do
      # class
      ...
      # regexp
      __binding_value_valid__?( /some_regexp/ ).should == true
      # text
