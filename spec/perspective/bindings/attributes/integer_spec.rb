...
describe ::Perspective::Bindings::Attributes::Integer do
  ...
  it 'can ensure class instances are valid binding objects' do
    class ::Perspective::Bindings::Attributes::Integer::Mock
      include ::Perspective::Bindings::Attributes::Integer
    end
    ::Perspective::Bindings::Attributes::Integer::Mock.new.instance_eval do
      # class
