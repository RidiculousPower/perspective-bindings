...
describe ::Perspective::Bindings::BindingDefinitions::Module do
  ...
  it 'can ensure class instances are valid binding objects' do
    class ::Perspective::Bindings::BindingDefinitions::Module::Mock
      include ::Perspective::Bindings::BindingDefinitions::Module
    end
    ::Perspective::Bindings::BindingDefinitions::Module::Mock.new.instance_eval do
      # class
