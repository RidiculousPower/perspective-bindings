...
describe ::Perspective::Bindings::BindingDefinitions::Class do
  ...
  it 'can ensure class instances are valid binding objects' do
    class ::Perspective::Bindings::BindingDefinitions::Class::Mock
      include ::Perspective::Bindings::BindingDefinitions::Class
    end
    ::Perspective::Bindings::BindingDefinitions::Class::Mock.new.instance_eval do
      # class
