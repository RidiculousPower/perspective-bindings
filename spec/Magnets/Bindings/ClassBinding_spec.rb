...
describe ::Magnets::Bindings::ClassBinding do
  ...
  it 'can initialize, validate parameters, establish its route, register ancestor' do
    ...
    container_instance = ::Magnets::Bindings::ClassBinding.new( :binding_name, ::Magnets::Bindings::ClassBinding::ContainerMock1 )
    ...
    # with ancestor
    ancestor_instance = ::Magnets::Bindings::ClassBinding.new( nil, nil, container_instance )
    ...
    container_ancestor_instance = ::Magnets::Bindings::ClassBinding.new( nil, ::Magnets::Bindings::ClassBinding::ContainerMock2, ancestor_instance )
    ...
    # with base route
    baseroute_instance = ::Magnets::Bindings::ClassBinding.new( :binding_name, nil, nil, [ :path, :to, :binding ] )
    ...
    container_baseroute_instance = ::Magnets::Bindings::ClassBinding.new( :binding_name, ::Magnets::Bindings::ClassBinding::ContainerMock3, nil, [ :a, :path, :to, :binding ] )    
    ...
    ancestor_baseroute_instance = ::Magnets::Bindings::ClassBinding.new( nil, nil, container_baseroute_instance, [ :another, :path, :to, :binding ] )
    ...
    container_ancestor_baseroute_instance = ::Magnets::Bindings::ClassBinding.new( nil, ::Magnets::Bindings::ClassBinding::ContainerMock4, ancestor_baseroute_instance, [ :some, :other, :path, :to, :binding ] )
