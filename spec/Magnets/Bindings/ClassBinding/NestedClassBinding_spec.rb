...
describe ::Magnets::Bindings::ClassBinding::NestedClassBinding do
  ...
  before :all do
    ...
    class ::Magnets::Bindings::ClassBinding::NestedClassBindingMock < ::Magnets::Bindings::ClassBinding
  ...
  it 'can initialize, validate parameters, establish its route, register ancestor' do
    ...
    # no container class
    instance = ::Magnets::Bindings::ClassBinding::NestedClassBindingMock.new( ::Magnets::Bindings::ClassBinding::ContainerMock, :binding_name )
    ...
    container_instance = ::Magnets::Bindings::ClassBinding::NestedClassBindingMock.new( ::Magnets::Bindings::ClassBinding::ContainerMock, :binding_name, ::Magnets::Bindings::ClassBinding::ContainerMock1 )
    ...
    # with ancestor
    ancestor_instance = ::Magnets::Bindings::ClassBinding::NestedClassBindingMock.new( ::Magnets::Bindings::ClassBinding::ContainerMock, nil, nil, container_instance )
    ...
    container_ancestor_instance = ::Magnets::Bindings::ClassBinding::NestedClassBindingMock.new( ::Magnets::Bindings::ClassBinding::ContainerMock, nil, ::Magnets::Bindings::ClassBinding::ContainerMock2, ancestor_instance )
    ...
    # with base route
    ::Magnets::Bindings::ClassBinding::ContainerMock.__route_with_name__ = [ :path, :to, :binding ]
    baseroute_instance = ::Magnets::Bindings::ClassBinding::NestedClassBindingMock.new( ::Magnets::Bindings::ClassBinding::ContainerMock, :binding_name, nil, nil )
    ...
    ::Magnets::Bindings::ClassBinding::ContainerMock.__route_with_name__ = [ :a, :path, :to, :binding ]
    container_baseroute_instance = ::Magnets::Bindings::ClassBinding::NestedClassBindingMock.new( ::Magnets::Bindings::ClassBinding::ContainerMock, :binding_name, ::Magnets::Bindings::ClassBinding::ContainerMock3 )    
    ...
    ::Magnets::Bindings::ClassBinding::ContainerMock.__route_with_name__ = [ :another, :path, :to, :binding ]
    ancestor_baseroute_instance = ::Magnets::Bindings::ClassBinding::NestedClassBindingMock.new( ::Magnets::Bindings::ClassBinding::ContainerMock, nil, nil, container_baseroute_instance )
    ...
    ::Magnets::Bindings::ClassBinding::ContainerMock.__route_with_name__ = [ :some, :other, :path, :to, :binding ]
    container_ancestor_baseroute_instance = ::Magnets::Bindings::ClassBinding::NestedClassBindingMock.new( ::Magnets::Bindings::ClassBinding::ContainerMock, nil, ::Magnets::Bindings::ClassBinding::ContainerMock4, ancestor_baseroute_instance )
  ...
  it 'it can calculate the nested route from one container to another nested inside it' do
    ...
    instance = ::Magnets::Bindings::ClassBinding::NestedClassBindingMock.new( ::Magnets::Bindings::ClassBinding::ContainerMock, :binding_name )
    nested_instance = ::Magnets::Bindings::ClassBinding::NestedClassBindingMock.new( ::Magnets::Bindings::ClassBinding::ContainerMock, :binding_name )
  ...
  it 'can return sub-bindings that define containers nested inside this binding container class' do
    ...
    instance = ::Magnets::Bindings::ClassBinding::NestedClassBindingMock.new( ::Magnets::Bindings::ClassBinding::ContainerMock, :binding_name )
    some_binding_instance = ::Magnets::Bindings::ClassBinding::NestedClassBindingMock.new( ::Magnets::Bindings::ClassBinding::ContainerMock, :some_binding )
