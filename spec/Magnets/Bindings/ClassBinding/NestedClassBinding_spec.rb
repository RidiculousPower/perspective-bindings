...
describe ::Magnets::Bindings::ClassBinding::NestedClassBinding do
  ...
  it 'can initialize, validate parameters, establish its route, register ancestor' do
    ...
    nesting_instance = ::Magnets::Bindings::ClassBinding.new( ::Magnets::Bindings::ClassBinding::ContainerMock, :nesting_binding_name )

    # no container class
    instance = ::Magnets::Bindings::ClassBinding::NestedClassBindingMock.new( nesting_instance, :binding_name )
    ...
    container_instance = ::Magnets::Bindings::ClassBinding::NestedClassBindingMock.new( nesting_instance, :binding_name, ::Magnets::Bindings::ClassBinding::ContainerMock1 )
    ...
    # with ancestor
    ancestor_instance = ::Magnets::Bindings::ClassBinding::NestedClassBindingMock.new( nesting_instance, nil, nil, container_instance )
    ...
    container_ancestor_instance = ::Magnets::Bindings::ClassBinding::NestedClassBindingMock.new( nesting_instance, nil, nil, container_instance )
    container_ancestor_instance = ::Magnets::Bindings::ClassBinding::NestedClassBindingMock.new( nesting_instance, nil, ::Magnets::Bindings::ClassBinding::ContainerMock2, ancestor_instance )
    ...
    baseroute_instance = ::Magnets::Bindings::ClassBinding::NestedClassBindingMock.new( nesting_instance, :binding_name, nil, nil )
    ...
    container_baseroute_instance = ::Magnets::Bindings::ClassBinding::NestedClassBindingMock.new( nesting_instance, :binding_name, ::Magnets::Bindings::ClassBinding::ContainerMock3 )    
    ...
    ancestor_baseroute_instance = ::Magnets::Bindings::ClassBinding::NestedClassBindingMock.new( nesting_instance, nil, nil, container_baseroute_instance )
    ...
    container_ancestor_baseroute_instance = ::Magnets::Bindings::ClassBinding::NestedClassBindingMock.new( nesting_instance, nil, ::Magnets::Bindings::ClassBinding::ContainerMock4, ancestor_baseroute_instance )
  ...
  it 'it can calculate the nested route from one container to another nested inside it' do
    ...
    ::Magnets::Bindings::ClassBinding::NestedClassBinding.instance_method( :nested_route ).should == ::Magnets::Bindings::ClassBinding::NestedClassBinding.instance_method( :__nested_route__ )

    nesting_instance = ::Magnets::Bindings::ClassBinding.new( ::Magnets::Bindings::ClassBinding::ContainerMock, :nesting_binding_name )

    instance = ::Magnets::Bindings::ClassBinding::NestedClassBindingMock.new( nesting_instance, :binding_name )
    nested_instance = ::Magnets::Bindings::ClassBinding::NestedClassBindingMock.new( nesting_instance, :binding_name )
  ...
  it 'can return sub-bindings that define containers nested inside this binding container class' do
    nesting_instance = ::Magnets::Bindings::ClassBinding.new( ::Magnets::Bindings::ClassBinding::ContainerMock, :nesting_binding_name )
    instance = ::Magnets::Bindings::ClassBinding::NestedClassBindingMock.new( nesting_instance, :binding_name )
    some_binding_instance = ::Magnets::Bindings::ClassBinding::NestedClassBindingMock.new( nesting_instance, :some_binding )
