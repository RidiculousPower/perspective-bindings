...
describe ::Magnets::Bindings::Attributes::Complex do
  ...
  it 'can ensure class instances are valid binding objects' do
    class ::Magnets::Bindings::Attributes::Complex::Mock
      include ::Magnets::Bindings::Attributes::Complex
    end
    ::Magnets::Bindings::Attributes::Complex::Mock.new.instance_eval do
      # class
