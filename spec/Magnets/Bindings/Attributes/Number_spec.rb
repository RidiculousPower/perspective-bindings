...
describe ::Magnets::Bindings::Attributes::Number do
  ...
  it 'can ensure class instances are valid binding objects' do
    class ::Magnets::Bindings::Attributes::Number::Mock
      include ::Magnets::Bindings::Attributes::Number
    end
    ::Magnets::Bindings::Attributes::Number::Mock.new.instance_eval do
      # class
