...
describe ::Magnets::Bindings::Attributes::Multiple do
  ...
  it 'can ensure class instances are valid binding objects' do
    class ::Magnets::Bindings::Attributes::Multiple::Mock
      include ::Magnets::Bindings::Attributes::Multiple
      include ::Magnets::Bindings::Attributes::Class
      include ::Magnets::Bindings::Attributes::Integer
      include ::Magnets::Bindings::Attributes::Float
    end
    ::Magnets::Bindings::Attributes::Multiple::Mock.new.instance_eval do
      # class
