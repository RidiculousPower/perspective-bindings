...
describe ::Magnets::Bindings::Attributes::Regexp do
  ...
  it 'can ensure class instances are valid binding objects' do
    class ::Magnets::Bindings::Attributes::Regexp::Mock
      include ::Magnets::Bindings::Attributes::Regexp
    end
    ::Magnets::Bindings::Attributes::Regexp::Mock.new.instance_eval do
      # class
