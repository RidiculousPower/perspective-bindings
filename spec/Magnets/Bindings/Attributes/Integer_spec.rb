...
describe ::Magnets::Bindings::Attributes::Integer do
  ...
  it 'can ensure class instances are valid binding objects' do
    class ::Magnets::Bindings::Attributes::Integer::Mock
      include ::Magnets::Bindings::Attributes::Integer
    end
    ::Magnets::Bindings::Attributes::Integer::Mock.new.instance_eval do
      # class
