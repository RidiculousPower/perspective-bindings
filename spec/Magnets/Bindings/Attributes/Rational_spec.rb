...
describe ::Magnets::Bindings::Attributes::Rational do
  ...
  it 'can ensure class instances are valid binding objects' do
    class ::Magnets::Bindings::Attributes::Rational::Mock
      include ::Magnets::Bindings::Attributes::Rational
    end
    ::Magnets::Bindings::Attributes::Rational::Mock.new.instance_eval do
      # class
