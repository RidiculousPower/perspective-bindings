...
describe ::Magnets::Bindings::Binding::Definition::Complex do
  ...
  it 'can ensure class instances are valid binding objects' do
    class ::Magnets::Bindings::Binding::Definition::Complex::Mock
      include ::Magnets::Bindings::Binding::Definition::Complex
    end
    ::Magnets::Bindings::Binding::Definition::Complex::Mock.new.instance_eval do
      # class
