...
describe ::Magnets::Bindings::Binding::Definition::Number do
  ...
  it 'can ensure class instances are valid binding objects' do
    class ::Magnets::Bindings::Binding::Definition::Number::Mock
      include ::Magnets::Bindings::Binding::Definition::Number
    end
    ::Magnets::Bindings::Binding::Definition::Number::Mock.new.instance_eval do
      # class
      ...
      # complex
      __ensure_binding_value_valid__( Complex( 1, 2 ) ).should == true
      # rational
      __ensure_binding_value_valid__( Rational( 1, 2 ) ).should == true
