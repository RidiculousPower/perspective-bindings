...
describe ::Magnets::Bindings::Binding::Definition::Float do
  ...
  it 'can ensure class instances are valid binding objects' do
    class ::Magnets::Bindings::Binding::Definition::Float::Mock
      include ::Magnets::Bindings::Binding::Definition::Float
    end
    ::Magnets::Bindings::Binding::Definition::Float::Mock.new.instance_eval do
      # class
