...
describe ::Magnets::Bindings::Binding::Definition::Text do
  ...
  it 'can ensure class instances are valid binding objects' do
    class ::Magnets::Bindings::Binding::Definition::Text::Mock
      include ::Magnets::Bindings::Binding::Definition::Text
    end
    ::Magnets::Bindings::Binding::Definition::Text::Mock.new.instance_eval do
      # class
      ...
      __ensure_binding_value_valid__( :symbol ).should == true
      # true_false
