...
describe ::Magnets::Bindings::Binding::Definition::Module do
  ...
  it 'can ensure class instances are valid binding objects' do
    class ::Magnets::Bindings::Binding::Definition::Module::Mock
      include ::Magnets::Bindings::Binding::Definition::Module
    end
    ::Magnets::Bindings::Binding::Definition::Module::Mock.new.instance_eval do
      # class
      __ensure_binding_value_valid__( Object ).should == false
      # module
      __ensure_binding_value_valid__( Kernel ).should == true
      # file
