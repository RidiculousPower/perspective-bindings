...
describe ::Magnets::Bindings::Binding::Definition::Class do
  ...
  it 'can ensure class instances are valid binding objects' do
    class ::Magnets::Bindings::Binding::Definition::Class::Mock
      include ::Magnets::Bindings::Binding::Definition::Class
    end
    ::Magnets::Bindings::Binding::Definition::Class::Mock.new.instance_eval do
      # class
