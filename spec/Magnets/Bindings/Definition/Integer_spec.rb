...
describe ::Magnets::Bindings::Binding::Definition::Integer do
  ...
  it 'can ensure class instances are valid binding objects' do
    class ::Magnets::Bindings::Binding::Definition::Integer::Mock
      include ::Magnets::Bindings::Binding::Definition::Integer
    end
    ::Magnets::Bindings::Binding::Definition::Integer::Mock.new.instance_eval do
      # class
