...
describe ::Magnets::Bindings::Binding::Definition::Regexp do
  ...
  it 'can ensure class instances are valid binding objects' do
    class ::Magnets::Bindings::Binding::Definition::Regexp::Mock
      include ::Magnets::Bindings::Binding::Definition::Regexp
    end
    ::Magnets::Bindings::Binding::Definition::Regexp::Mock.new.instance_eval do
      # class
      ...
      # regexp
      __ensure_binding_value_valid__( /some_regexp/ ).should == true
      # text
