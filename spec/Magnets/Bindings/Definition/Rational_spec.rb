...
describe ::Magnets::Bindings::Binding::Definition::Rational do
  ...
  it 'can ensure class instances are valid binding objects' do
    class ::Magnets::Bindings::Binding::Definition::Rational::Mock
      include ::Magnets::Bindings::Binding::Definition::Rational
    end
    ::Magnets::Bindings::Binding::Definition::Rational::Mock.new.instance_eval do
      # class
