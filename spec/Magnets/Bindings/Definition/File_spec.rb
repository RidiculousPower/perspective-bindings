...
describe ::Magnets::Bindings::Binding::Definition::File do
  ...
  it 'can ensure class instances are valid binding objects' do
    class ::Magnets::Bindings::Binding::Definition::File::Mock
      include ::Magnets::Bindings::Binding::Definition::File
    end
    ::Magnets::Bindings::Binding::Definition::File::Mock.new.instance_eval do
      # class
      __ensure_binding_value_valid__( Object ).should == false
      # module
      __ensure_binding_value_valid__( Kernel ).should == false
      # file
      __ensure_binding_value_valid__( File.new( __FILE__ ) ).should == true
      # integer
