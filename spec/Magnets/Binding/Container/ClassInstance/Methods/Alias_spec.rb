...
describe ::Magnets::Binding::Container::ClassInstance::Methods::Alias do
  ...
  before :all do
    class ::Magnets::Binding::Container::ClassInstance::Methods::Alias::Mock
      extend ::Magnets::Binding::Container::ClassInstance::Methods::Alias
  ...
  it 'can declare an aliased binding getter instance method' do
    ...
    ::Magnets::Binding::Container::ClassInstance::Methods::Alias::Mock.new.instance_eval do
