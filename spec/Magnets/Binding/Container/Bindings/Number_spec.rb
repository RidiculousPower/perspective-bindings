...
describe ::Magnets::Binding::Container::ClassInstance::Bindings::Number do

  before :all do
    class ::Magnets::Binding::Container::ClassInstance::Bindings::Number::Mock
  ...
  it 'can define numbers' do
    ...
    class ::Magnets::Binding::Container::ClassInstance::Bindings::Number::Mock
      ...
      attr_number :some_number => ::Magnets::Binding::Container::ClassInstance::Bindings::Number::Mock::View, & config_proc
      ...
      binding_instance.__view_class__.should == ::Magnets::Binding::Container::ClassInstance::Bindings::Number::Mock::View

      has_binding?( :some_number ).should == true

    end

    instance = ::Magnets::Binding::Container::ClassInstance::Bindings::Number::Mock.new
    ...
    instance.class.__binding_configuration__( :some_number ).render_value_valid?( instance.some_number )
  ...
  it 'can define required numbers' do
    ...
    instance = ::Magnets::Binding::Container::ClassInstance::Bindings::Number::Mock.new
    Proc.new { instance.some_numbers = [ :object ] }.should raise_error( ::Magnets::Binding::Exception::BindingInstanceInvalidTypeError )
    Proc.new { instance.some_numbers = :object }.should raise_error( ::Magnets::Binding::Exception::BindingInstanceInvalidTypeError )
    ...
    Proc.new { instance.some_numbers = [ Rational( 2, 3 ), 42, :other ] }.should raise_error( ::Magnets::Binding::Exception::BindingInstanceInvalidTypeError )

    instance.class.__binding_configuration__( :some_numbers ).render_value_valid?( instance.some_numbers )
  ...
  it 'can define required numbers' do
    ...
    instance = ::Magnets::Binding::Container::ClassInstance::Bindings::Number::Mock.new
    Proc.new { instance.some_required_numbers = [ 42, :other ] }.should raise_error( ::Magnets::Binding::Exception::BindingInstanceInvalidTypeError )
    Proc.new { instance.some_required_numbers = [ Object, 42 ] }.should raise_error( ::Magnets::Binding::Exception::BindingInstanceInvalidTypeError )
    Proc.new { instance.some_required_numbers = :other }.should raise_error( ::Magnets::Binding::Exception::BindingInstanceInvalidTypeError )
