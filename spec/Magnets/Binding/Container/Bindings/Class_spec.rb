...
describe ::Magnets::Binding::Container::ClassInstance::Bindings::Class do

  before :all do
    class ::Magnets::Binding::Container::ClassInstance::Bindings::Class::Mock
  ...
  it 'can define classes' do
    ...
    class ::Magnets::Binding::Container::ClassInstance::Bindings::Class::Mock
      ...
      attr_class :some_class => ::Magnets::Binding::Container::ClassInstance::Bindings::Class::Mock::View, & config_proc
      ...
      binding_instance.__view_class__.should == ::Magnets::Binding::Container::ClassInstance::Bindings::Class::Mock::View
      
      has_binding?( :some_class ).should == true

    end
    
    instance = ::Magnets::Binding::Container::ClassInstance::Bindings::Class::Mock.new
    ...
    instance.class.__binding_configuration__( :some_class ).render_value_valid?( instance.some_class )
  ...
  it 'can define required classes' do
    ...
    instance = ::Magnets::Binding::Container::ClassInstance::Bindings::Class::Mock.new
    Proc.new { instance.some_classes = [ :object ] }.should raise_error( ::Magnets::Binding::Exception::BindingInstanceInvalidTypeError )
    Proc.new { instance.some_classes = :object }.should raise_error( ::Magnets::Binding::Exception::BindingInstanceInvalidTypeError )
    instance.some_classes = Object
    instance.some_classes = [ Object, Class ]
    Proc.new { instance.some_classes = [ Object, :object ] }.should raise_error( ::Magnets::Binding::Exception::BindingInstanceInvalidTypeError )
    
    instance.class.__binding_configuration__( :some_classes ).render_value_valid?( instance.some_classes )
  ...
  it 'can define required classes' do
    ...
    instance = ::Magnets::Binding::Container::ClassInstance::Bindings::Class::Mock.new
    Proc.new { instance.some_required_classes = [ :object, :other ] }.should raise_error( ::Magnets::Binding::Exception::BindingInstanceInvalidTypeError )
    Proc.new { instance.some_required_classes = [ Object, :other ] }.should raise_error( ::Magnets::Binding::Exception::BindingInstanceInvalidTypeError )
    Proc.new { instance.some_required_classes = :other }.should raise_error( ::Magnets::Binding::Exception::BindingInstanceInvalidTypeError )
