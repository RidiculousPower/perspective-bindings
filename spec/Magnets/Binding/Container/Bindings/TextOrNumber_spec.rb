...
describe ::Magnets::Binding::Container::ClassInstance::Bindings::TextOrNumber do

  before :all do
    class ::Magnets::Binding::Container::ClassInstance::Bindings::TextOrNumber::Mock
  ...
  it 'can define texts' do
    ...
    class ::Magnets::Binding::Container::ClassInstance::Bindings::TextOrNumber::Mock
      ...
      attr_text_or_number :some_text_or_number => ::Magnets::Binding::Container::ClassInstance::Bindings::TextOrNumber::Mock::View, & config_proc
      ...
      binding_instance.__view_class__.should == ::Magnets::Binding::Container::ClassInstance::Bindings::TextOrNumber::Mock::View

      has_binding?( :some_text_or_number ).should == true

    end

    instance = ::Magnets::Binding::Container::ClassInstance::Bindings::TextOrNumber::Mock.new
    ...
    instance.class.__binding_configuration__( :some_text_or_number ).render_value_valid?( instance.some_text_or_number )
  ...
  it 'can define required texts' do
    ...
    instance = ::Magnets::Binding::Container::ClassInstance::Bindings::TextOrNumber::Mock.new
    Proc.new { instance.some_text_or_numbers = [ :object, Class ] }.should raise_error( ::Magnets::Binding::Exception::BindingInstanceInvalidTypeError )
    Proc.new { instance.some_text_or_numbers = Class }.should raise_error( ::Magnets::Binding::Exception::BindingInstanceInvalidTypeError )
    ...
    Proc.new { instance.some_text_or_numbers = [ Object, :text ] }.should raise_error( ::Magnets::Binding::Exception::BindingInstanceInvalidTypeError )

    instance.class.__binding_configuration__( :some_text_or_numbers ).render_value_valid?( instance.some_text_or_numbers )
  ...
  it 'can define required texts' do
    ...
    instance = ::Magnets::Binding::Container::ClassInstance::Bindings::TextOrNumber::Mock.new
    Proc.new { instance.some_required_text_or_numbers = [ Class, :other ] }.should raise_error( ::Magnets::Binding::Exception::BindingInstanceInvalidTypeError )
    Proc.new { instance.some_required_text_or_numbers = [ Object, 42 ] }.should raise_error( ::Magnets::Binding::Exception::BindingInstanceInvalidTypeError )
    Proc.new { instance.some_required_text_or_numbers = Object }.should raise_error( ::Magnets::Binding::Exception::BindingInstanceInvalidTypeError )
