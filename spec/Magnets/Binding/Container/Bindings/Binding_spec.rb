...
describe ::Magnets::Binding::Container::ClassInstance::Bindings::Binding do

  before :all do
    class ::Magnets::Binding::Container::ClassInstance::Bindings::Binding::Mock
  ...
  it 'can define bindings' do
    ...
    class ::Magnets::Binding::Container::ClassInstance::Bindings::Binding::Mock
      ...
      attr_binding :some_other_binding, ::Magnets::Binding::Container::ClassInstance::Bindings::Binding::Mock::View, & config_proc
      ...
      config.is_a?( ::Magnets::Binding ).should == true
      ...
      other_config.__view_class__.should == ::Magnets::Binding::Container::ClassInstance::Bindings::Binding::Mock::View
    ...
    instance = ::Magnets::Binding::Container::ClassInstance::Bindings::Binding::Mock.new
    ...
    instance.class.__binding_configuration__( :some_binding ).render_value_valid?( instance.some_binding )
  ...
  it 'can define required bindings' do
    ...
    instance.class.__binding_configuration__( :some_bindings ).render_value_valid?( instance.some_bindings )
