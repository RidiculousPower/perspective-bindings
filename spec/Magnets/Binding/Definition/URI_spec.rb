...
describe ::Magnets::Binding::Definition::URI do
  ...
  it 'can ensure class instances are valid binding objects' do
    class ::Magnets::Binding::Definition::URI::Mock
      include ::Magnets::Binding::Definition::URI
    end
    ::Magnets::Binding::Definition::URI::Mock.new.instance_eval do
      # class
