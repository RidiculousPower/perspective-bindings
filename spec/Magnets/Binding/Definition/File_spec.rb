...
describe ::Magnets::Binding::Definition::File do
  ...
  it 'can ensure class instances are valid binding objects' do
    class ::Magnets::Binding::Definition::File::Mock
      include ::Magnets::Binding::Definition::File
    end
    ::Magnets::Binding::Definition::File::Mock.new.instance_eval do
      # class
