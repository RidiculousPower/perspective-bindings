...
describe ::Magnets::Binding::Definition::Integer do
  ...
  it 'can ensure class instances are valid binding objects' do
    class ::Magnets::Binding::Definition::Integer::Mock
      include ::Magnets::Binding::Definition::Integer
    end
    ::Magnets::Binding::Definition::Integer::Mock.new.instance_eval do
      # class
