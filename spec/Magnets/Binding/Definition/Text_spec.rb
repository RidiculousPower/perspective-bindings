...
describe ::Magnets::Binding::Definition::Text do
  ...
  it 'can ensure class instances are valid binding objects' do
    class ::Magnets::Binding::Definition::Text::Mock
      include ::Magnets::Binding::Definition::Text
    end
    ::Magnets::Binding::Definition::Text::Mock.new.instance_eval do
      # class
      ...
      binding_value_valid?( :symbol ).should == true
      # true_false
