...
describe ::Magnets::Binding::Definition::Module do
  ...
  it 'can ensure class instances are valid binding objects' do
    class ::Magnets::Binding::Definition::Module::Mock
      include ::Magnets::Binding::Definition::Module
    end
    ::Magnets::Binding::Definition::Module::Mock.new.instance_eval do
      # class
