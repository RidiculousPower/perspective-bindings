...
describe ::Magnets::Binding::Definition::TrueFalse do
  ...
  it 'can ensure class instances are valid binding objects' do
    class ::Magnets::Binding::Definition::TrueFalse::Mock
      include ::Magnets::Binding::Definition::TrueFalse
    end
    ::Magnets::Binding::Definition::TrueFalse::Mock.new.instance_eval do
      # class
