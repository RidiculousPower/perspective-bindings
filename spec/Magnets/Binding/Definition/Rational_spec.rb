...
describe ::Magnets::Binding::Definition::Rational do
  ...
  it 'can ensure class instances are valid binding objects' do
    class ::Magnets::Binding::Definition::Rational::Mock
      include ::Magnets::Binding::Definition::Rational
    end
    ::Magnets::Binding::Definition::Rational::Mock.new.instance_eval do
      # class
