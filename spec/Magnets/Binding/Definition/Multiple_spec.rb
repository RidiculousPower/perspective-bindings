...
describe ::Magnets::Binding::Definition::Multiple do
  ...
  it 'can ensure class instances are valid binding objects' do
    class ::Magnets::Binding::Definition::Multiple::Mock
      include ::Magnets::Binding::Definition::Multiple
      include ::Magnets::Binding::Definition::Class
      include ::Magnets::Binding::Definition::Integer
      include ::Magnets::Binding::Definition::Float
    end
    ::Magnets::Binding::Definition::Multiple::Mock.new.instance_eval do
      # class
