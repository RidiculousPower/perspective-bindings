...
describe ::Magnets::Binding::Definition::Complex do
  ...
  it 'can ensure class instances are valid binding objects' do
    class ::Magnets::Binding::Definition::Complex::Mock
      include ::Magnets::Binding::Definition::Complex
    end
    ::Magnets::Binding::Definition::Complex::Mock.new.instance_eval do
      # class
