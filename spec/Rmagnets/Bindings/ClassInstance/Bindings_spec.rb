...
describe ::Rmagnets::Bindings::ClassInstance::Bindings do
  ...
  it 'can create a binding' do
    ...
    class ::Rmagnets::Bindings::ClassInstance::Bindings::Mock
      ...
      binding_configuration( :some_binding ).configuration_procs.should == [ configuration_proc_one ]
      binding_configuration( :some_other_binding ).configuration_procs.should == [ configuration_proc_two ]
  ...
  it 'can create bindings from args' do
    ...
    class ::Rmagnets::Bindings::ClassInstance::Bindings::Mock
      ...
      binding_configuration( :some_binding ).configuration_procs.should == [ configuration_proc_one ]
      binding_configuration( :another_binding ).configuration_procs.should == [ configuration_proc_one ]
      binding_configuration( :yet_another_binding ).configuration_procs.should == [ configuration_proc_one ]
      binding_configuration( :some_other_binding ).configuration_procs.should == [ configuration_proc_one ]
